...
public class PorcupineManager {
    ...
    public init(modelFilePath: String, wakeKeywordConfigurations: [WakeWordConfiguration], onDetection: ((WakeWordConfiguration) -> Void)?) throws {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(onAudioSessionInterruption(_:)), name: NSNotification.Name.AVCaptureSessionInterruptionEnded, object: audioSession)
    }
